...
#ifndef SPEAKER_RECOGNIZER_XVECTOR_H_
#define SPEAKER_RECOGNIZER_XVECTOR_H_
...
class DLL_API SpeakerRecognizerXVector: public SpeakerRecognizer
{
public:
	SpeakerRecognizerXVector(int sample_rate = 16000, bool recognize_gender = false);

public:
	virtual ~SpeakerRecognizerXVector();

private:
	SpeakerRecognizerXVector(const SpeakerRecognizerXVector &);
	SpeakerRecognizerXVector & operator=(const SpeakerRecognizerXVector &);
...
private:
	// 提取XVector
	// feat: ndim x nframes
	Eigen::MatrixXd ExtractXVector(Eigen::MatrixXd feat);
	// 识别性别
	bool recognize_gender_;
...
#endif // SPEAKER_RECOGNIZER_XVECTOR_H_
